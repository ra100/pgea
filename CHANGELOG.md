...
- *(release)* use the correct version tag in release asset filenames

## [0.4.1](https://github.com/ra100/pgea/compare/v0.4.0...v0.4.1) - 2026-07-22

### Fixed

- *(response)* stop double-quoting array literals; extend e2e coverage to every feature
- *(extended-query)* bind numeric/boolean params with native Data API Field variants
- *(config)* accept AWS-managed secret ARN names in secret_arn validation

## [0.4.0](https://github.com/ra100/pgea/compare/v0.3.0...v0.4.0) - 2026-07-21

### Other

- drop dead test-mode pool allocation, narrow RdsClientPool::new visibility

## [0.3.0](https://github.com/ra100/pgea/compare/v0.2.2...v0.3.0) - 2026-07-21

### Added

- pool RDS Data API clients per (target, profile)

### Fixed

- *(review)* add concurrent-race test for RdsClientPool::get_or_build

## [0.2.2](https://github.com/ra100/pgea/compare/v0.2.1...v0.2.2) - 2026-07-21

### Fixed

- *(ci)* trigger autotag after release-plz completes, not in parallel

### Other

- run the real-Postgres integration suite on every PR
- add real-Postgres-backed RdsClient test double
